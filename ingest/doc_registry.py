...
REGISTRY = [
    ...
    },
    {
        ...
        "doc_type": "circular",
        "title": "Guidelines for FDSS as per IS/spec 22001 — Amendment 1 (PED EnHM)",  # (*) scanned
        "source": "RDSO/PED EnHM, 30.11.2024",
        "system": "FSDS",
        "default_oem": None,
        "coach_type": ["common"],
        "subsystem": "fire detection",
    ...
    },
    {
        ...
        "doc_type": "circular",
        "title": "Compliance of RDSO Specification RDSO/2008/CG-04 & FSDS Guidelines",  # (*) scanned
        "source": "RDSO spec RDSO/2008/CG-04, 27.11.2024",
        "system": "FSDS",
        "default_oem": None,
        "coach_type": ["common"],
        "subsystem": "fire detection",
    ...
    },
    {
        ...
        "title": "RCF LHB Carriage Assembly Instruction CAI/RCF/MECH/LHB/064",  # (*) scanned
        "source": "RCF CAI/RCF/MECH/LHB/064",
        "system": "FSDS",
        "default_oem": None,
        "coach_type": ["LHB"],
        "subsystem": "fire detection",
